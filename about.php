...
<!--                              <li>É um parceiro? então faça seu <a href="" data-reveal-id="broker-login-form">Login</a></li>-->
        ...
        <section id="secondary-header">
            <div class="row">
                <div class="small-12 column">
                    <div>
                        <h1>Sobre a Virtus Rastreamento</h1>
        ...
        <section id="about">
            <div class="row">
                <div class="medium-8 column">
                    <p>Há varios anos com tecnologia avançada de rastreamento, a Virtus oferece produtos para a proteção contra roubo e furto de veículos, cargas e frotas, com resultados significativos e índices imbatíveis de eficiência, dedicada à inovação tecnológica e a qualidade do serviço prestado, sempre buscando proporcionar aos seus clientes um atendimento único e diferenciado.<br><br>

Com seu exclusivo Sistema de Rastreamento, a Virtus tem acesso às informações em tempo real, permitindo que medidas de segurança sejam tomadas no exato momento da ocorrência de um sinistro. <br><br>

Porém, você cliente, merece ainda mais. Por isso, a Virtus vai além do rastreamento como forma de proteger o patrimônio, baseando-se também na interpretação dos dados originados pelos rastreadores (telemetria), a fim de obter mais eficiência nos serviços prestados.</p>
                </div>
                <div class="medium-4 column hide-for-small-only">
                    <i class="flaticon-buildings8"></i>
                </div>
            </div>
            <div class="row values">
                <div class="medium-4 column">
                    <h4>Missão</h4>
                    <p>Proporcionar aos nossos clientes um eficiente sistema de segurança para veículos familiares e frotas, a fim de possibilitar segurança conforto e redução de custos.</p>
                </div>
                <div class="medium-4 column">
                    <h4>Visão</h4>
                    <p>Hoje existimos com a finalidade de preecher uma lacuna do mercado carente de soluções simples e econômicas, capaz de atender a todas as classes.</p>
                </div>
                <div class="medium-4 column">
                    <h4>Valores</h4>
                    <p>Monitorar os veículos através de softwares e hardwares de última geração e buscar a melhoria continua da qualidade, a fim de garantir a satisfação do cliente.</p>
                </div>
            </div>
        </section>
